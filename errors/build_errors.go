// Package errors contains errors for the domain "ii".
//
...
const MetricsNotFoundErrorCode = "ii_metrics_not_found_error"

// IsMetricsNotFoundError tests whether a given error is an instance of "not_found_error".
func IsMetricsNotFoundError(err errawrgo.Error) bool {
	return err != nil && err.Is(MetricsNotFoundErrorCode)
}

// IsMetricsNotFoundError tests whether a given error is an instance of "not_found_error".
func (External) IsMetricsNotFoundError(err errawrgo.Error) bool {
...
const MetricsUnknownErrorCode = "ii_metrics_unknown_error"

// IsMetricsUnknownError tests whether a given error is an instance of "unknown_error".
func IsMetricsUnknownError(err errawrgo.Error) bool {
	return err != nil && err.Is(MetricsUnknownErrorCode)
}

// IsMetricsUnknownError tests whether a given error is an instance of "unknown_error".
func (External) IsMetricsUnknownError(err errawrgo.Error) bool {
