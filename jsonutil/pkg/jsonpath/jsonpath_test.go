...
//
// https://github.com/PaesslerAG/jsonpath/blob/c18d0f043db32b5d4295e14c6518fa9160e45d15/jsonpath_test.go
//
...
func TestCustomLanguage(t *testing.T) {
	lang := gval.NewLanguage(
		...
		gval.PrefixExtension('{', func(ctx context.Context, p *gval.Parser) (gval.Evaluable, error) {
			e, err := p.ParseSublanguage(ctx, jsonpath.Language(jsonpath.WithInitialPath{}))
			if err != nil {
				return nil, err
			}
