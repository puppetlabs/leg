...
//
// https://github.com/PaesslerAG/jsonpath/blob/c18d0f043db32b5d4295e14c6518fa9160e45d15/placeholder_test.go
//
...
func TestWildcardsExtension(t *testing.T) {
	...
	for _, tt := range tests {
		tt.lang = jsonpath.Language(jsonpath.WithPlaceholders{})
