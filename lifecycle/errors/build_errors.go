// Package errors contains errors for the domain "lil".
//
...
var Domain = &impl.ErrorDomain{
	Key:   "lil",
	Title: "Insights Lifecycle Library",
}
...
const CloserErrorCode = "lil_closer_error"

// IsCloserError tests whether a given error is an instance of "error".
func IsCloserError(err errawrgo.Error) bool {
	return err != nil && err.Is(CloserErrorCode)
}

// IsCloserError tests whether a given error is an instance of "error".
func (External) IsCloserError(err errawrgo.Error) bool {
...
const CloserPanicErrorCode = "lil_closer_panic_error"

// IsCloserPanicError tests whether a given error is an instance of "panic_error".
func IsCloserPanicError(err errawrgo.Error) bool {
	return err != nil && err.Is(CloserPanicErrorCode)
}

// IsCloserPanicError tests whether a given error is an instance of "panic_error".
func (External) IsCloserPanicError(err errawrgo.Error) bool {
