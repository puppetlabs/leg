// Package errors contains errors for the domain "lin".
//
...
var Domain = &impl.ErrorDomain{
	Key:   "lin",
	Title: "Insights Net Utils Library",
}
...
const BackoffContextCancelledErrorCode = "lin_backoff_context_cancelled_error"

// IsBackoffContextCancelledError tests whether a given error is an instance of "context_cancelled_error".
func IsBackoffContextCancelledError(err errawrgo.Error) bool {
	return err != nil && err.Is(BackoffContextCancelledErrorCode)
}

// IsBackoffContextCancelledError tests whether a given error is an instance of "context_cancelled_error".
func (External) IsBackoffContextCancelledError(err errawrgo.Error) bool {
